...
enum WEAPON_SLOTS {MACHETE, REVOLVER, WINCHESTER, COLTSHOTGUN}
var slots_unlocked = {
	WEAPON_SLOTS.MACHETE:true,
	WEAPON_SLOTS.REVOLVER:true,
	WEAPON_SLOTS.WINCHESTER:true,
	WEAPON_SLOTS.COLTSHOTGUN:true
}
...
func switch_to_next_weapon():
	cur_slot=(cur_slot+1)%slots_unlocked.size()#<<<<<<<<<<<<<THIS
...
func switch_to_last_weapon():
	cur_slot=posmod((cur_slot-1),slots_unlocked.size())#<<<<<<<<<<<<AND THIS SORT OF DO THE SAME THING
	if !slots_unlocked[cur_slot]:
